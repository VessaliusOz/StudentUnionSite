...
class suChef(models.Model):
    name = models.CharField(max_length=20, default='主席', verbose_name='主席', unique=True)
...
class X_news(models.Model):
    ...
    image = models.ImageField(upload_to='xnews', verbose_name='视频缩略图', default=None, null=True, blank=True)
    video = models.CharField(max_length=200, blank=True, verbose_name='视频链接', default=None, null=True)
...
class X_activity(models.Model):
    ...
    body = models.TextField(verbose_name='内容')
    image = models.ImageField(upload_to='activity', verbose_name='视频缩略图', blank=True, default=None, null=True)
...
class School(models.Model):
    ''' 学院的学生会 '''
    name = models.CharField(max_length=100, verbose_name='院会名称', unique=True)
    introduction = models.TextField(verbose_name='介绍')
    chef = models.CharField(max_length=20, verbose_name='主席')
    chef_introduction = models.TextField(verbose_name='主席介绍')
    video_url = models.CharField(max_length=200, default='视频链接', blank=True, verbose_name='视频链接')
    image = models.ImageField(upload_to='school', default=None, null=True, blank=True, verbose_name='缩略图')
...
class S_news(models.Model):  # 院会的新闻
    title = models.CharField(max_length=100, verbose_name='标题', default='标题', unique=True)
    body = models.TextField(verbose_name='内容')
    image = models.ImageField(upload_to='snews', verbose_name='视频缩略图',default=None, null=True, blank=True)
    video = models.CharField(max_length=200, blank=True, verbose_name='视频链接', default=None, null=True)
    exc_editor = models.CharField(max_length=20, default='本新闻执行编辑', verbose_name='执行编辑')
    duty_editor = models.CharField(max_length=20, default='本新闻责任编辑', verbose_name='责任编辑')
    view_num = models.IntegerField(default=0, verbose_name='浏览次数')
...
class Information(models.Model):
    ...
    video_url = models.CharField(max_length=200, default=None, null=True, blank=True, verbose_name='视频链接')
...
class Apply(models.Model):
    ...
    school = models.CharField(max_length=100, verbose_name='学院', null=True, default=None)
    department = models.CharField(max_length=100, verbose_name='部门')
    introduction = models.TextField(verbose_name='自我介绍')
    image = models.ImageField(upload_to='apply', verbose_name='图片', default=None, null=True)
...
class Star(models.Model):  # 某月之星
    ...
    image = models.ImageField(upload_to='star', default=None, verbose_name='图片', null=True)
    text = models.TextField(default='', verbose_name='内容')
    datetime = models.DateTimeField(default=datetime.now, verbose_name='时间(排序用)')
...
class CourseInformation(models.Model):
    ...
    video = models.CharField(max_length=200, default=None, null=True, blank=True, verbose_name="视频链接")
